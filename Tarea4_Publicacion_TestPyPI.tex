...
Toda la configuracion vive en ese archivo. El completo esta en el repositorio; estas son las
partes que decidieron algo:

\begin{verbatim}
[build-system]
requires = ["hatchling >= 1.26"]     # el constructor que usa el tutorial
build-backend = "hatchling.build"

[project]
name = "act3-pipeline-mlops"         # unico en todo el indice
version = "0.1.0"
...
[project.scripts]
act3-demo = "act3_pipeline.cli:main" # crea el comando de consola

[tool.hatch.build.targets.wheel]
packages = ["src/act3_pipeline"]     # el nombre del paquete no es el de la distribucion
\end{verbatim}
...
Antes de subir nada validamos la metadata con \texttt{python -m twine check dist/*}, que
revisa que la descripcion, la licencia y los clasificadores esten bien formados. Los dos archivos
pasaron.
...
El usuario es literalmente \texttt{\_\_token\_\_}, no el correo. Un script de PowerShell
(\texttt{subir\_a\_testpypi.ps1}) carga esas variables, construye, valida y sube en una sola
corrida, de modo que el token nunca aparece en pantalla ni queda en el historial de comandos.
...
Con eso descarga el \emph{wheel} desde TestPyPI y resuelve las dependencias cientificas desde
PyPI, como se ve en la captura anterior.
